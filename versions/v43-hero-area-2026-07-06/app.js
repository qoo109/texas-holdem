...
const els = {
  ...
  heroInfoStackChips: document.querySelector("#heroInfoStackChips"),
  playerContributionValue: document.querySelector("#playerContributionValue"),
  playerStreetContribution: document.querySelector("#playerStreetContribution"),
...
function render() {
  ...
  const heroStreetContribution = human().bet || 0;
  ...
  if (els.heroInfoStackChips) els.heroInfoStackChips.innerHTML = renderMiniChipStack(human().stack);
  if (els.playerContributionValue) els.playerContributionValue.textContent = heroContribution;
  if (els.playerStreetContribution) els.playerStreetContribution.textContent = "本輪貢獻 " + heroStreetContribution;
