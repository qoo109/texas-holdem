...
- 現有 E2E 已覆蓋核心 smoke、版面編輯、加注、All-in、固定攤牌與本輪結算，但仍不能取代所有隨機牌局與長時間壓力測試。
...
基礎發布、靜態檢查、核心 Chromium E2E、版面編輯、加注／All-in、固定牌面攤牌與本輪結算路徑均已通過。測試強化階段暫告完成，下一步可回到遊戲功能與 UI 迭代；若繼續強化測試，優先項目為 Safari 對應的 Playwright WebKit。