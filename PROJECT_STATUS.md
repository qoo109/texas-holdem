...
- 現有 E2E 已覆蓋核心 smoke、版面編輯、加注與 All-in，但仍不能取代所有隨機牌局與長時間壓力測試。
...
基礎發布、靜態檢查、核心 Chromium E2E、版面編輯與玩家加注／All-in 路徑均已通過。下一項測試強化工作是建立可重現的攤牌與本輪結算 E2E，確認五張公共牌、勝負結算、底池歸零、勝者顯示與結算面板流程。